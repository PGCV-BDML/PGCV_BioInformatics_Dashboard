...
export default function InternshipEvaluationPage({
  ...
  // Simulated Internship Certificate Registry DB Rows
  const [certificates, setCertificates] = useState<CertificateRecord[]>([
    {
      id: "CERT-IN84KS9D",
      name: "Claire Redfield",
      programTitle: "Clinical Bioinformatics & Transcriptomics Internship",
      date: "2026-06-12",
    },
  ]);
  ...
  return (
    <div className="space-y-6 font-aileron">
      ...
      <div className="print:hidden flex items-center gap-2 border-b border-slate-100 pb-3">
        ...
        >
          1. Submit Internship Evaluation
        </button>
        <button
        ...
        >
          2. Internship Registry ({certificates.length})
        </button>
      </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full text-xs rounded-xl border-slate-200 focus:border-[#4ec2bb] focus:ring-[#4ec2bb] p-2.5 text-slate-700 bg-white"
                    >
                      <option value="Clinical Bioinformatics & Transcriptomics Internship">
                        Clinical Bioinformatics & Transcriptomics Internship
                      </option>
                    </select>
                  </div>
              ...
              <div className="bg-white border border-slate-200 rounded-[24px] p-8 text-center space-y-4 max-w-md mx-auto">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1">
                    Your evaluation performance record has been submitted. A
                    formal internship certificate has been created.
                  </p>
                </div>
          ...
          <div className="space-y-4">
            <div className="border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm font-extrabold text-slate-800 uppercase tracking-wide">
                  Internship Certificate Registry Log
                </h2>
              </div>
            </div>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50 border-b border-slate-200 text-[10px] font-extrabold uppercase tracking-wider text-slate-500">
                    ...
                    <th className="p-4">Placement Program Track</th>
                ...
                <tbody className="divide-y divide-slate-100 text-xs text-slate-700">
                  {certificates.length === 0 ? (
                    <tr>
                      ...
                      >
                        No verification rows found inside database table
                        parameters.
                      </td>
                    </tr>
                  ) : (
                        ...
                        <td className="p-4 text-center">
                          <div className="flex items-center justify-center gap-2">
                            <button
                              ...
                              title="View & Print Certificate Layout"
                            >
            ...
            <div className="w-full border border-slate-300 rounded-lg bg-white aspect-[1.414/1] flex flex-col p-8 sm:p-12 relative print:border-none print:m-0 print:p-6 print:w-full">
              ...
              <div className="text-center space-y-4 my-auto">
                ...
                <p className="text-[11px] text-slate-500 font-medium max-w-md mx-auto leading-relaxed">
                  ...
                  parameters, RNA-Seq data pipeline structures, and performance
                  expectations as an active clinical team member under the
                  placement track of
                </p>
