  ...
  import Link from "next/link"; // Imported Next Link component
  import {
    FolderGit2,
    Network,
    FileCheck2,
    ...
    Calendar,
    CheckSquare,
    ExternalLink, // Imported an icon indicator for the navigation action
  } from "lucide-react";
  import {
    BarChart,
    Bar,
    ...
    return (
      <div className="space-y-8 max-w-[1240px] mx-auto pb-16 px-4 font-aileron">
        ...
        <div className="bg-[#fffdf8] border border-[rgba(23,33,38,0.06)] rounded-[24px] p-6 shadow-sm">
          {/* Adjusted to align items on header side and added redirect link */}
