...
export default function ServicesListPage() {
  ...
  return (
    <div className="space-y-8 max-w-[1240px] mx-auto pb-16 px-4 font-aileron">
      ...
      <div className="bg-surface border border-[rgba(23,33,38,0.06)] rounded-[24px] p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {hardcodedServices.map((service, index) => (
            ...
            >
              ...
              <ArrowUpRight className="w-3.5 h-3.5 text-slate-400 opacity-0 group-hover:opacity-100 transition-opacity" aria-hidden="true" />
            </div>
          ))}
        </div>
      </div>
