...
export const projectsBreadcrumbs: BreadcrumbItem[] = [
...
export const tasksBreadcrumbs: BreadcrumbItem[] = [
  { label: "Dashboard", href: "/dashboard" },
  { label: "Tasks" },
];
...
export const covidSampleTrackerBreadcrumbs: BreadcrumbItem[] = [
  { label: "Dashboard", href: "/dashboard" },
  { label: "Sequence Analysis", href: "/dashboard/services" },
...
export const sequencingRunChecklistBreadcrumbs: BreadcrumbItem[] = [
  { label: "Dashboard", href: "/dashboard" },
  { label: "Sequence Analysis", href: "/dashboard/services" },
  { label: "Sequencing Run Checklist" },
];
